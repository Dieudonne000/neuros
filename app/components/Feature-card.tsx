    ...
    <div className="bg-white p-8">
      <div className="relative h-[350px] w-full max-w-[1000px] mx-auto overflow-hidden rounded-2xl bg-blue-500">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          <div className="inline-flex items-center rounded-full bg-white px-8 py-1 shadow-lg
            transition-all duration-300 ease-in-out
            border-[12px] border-[#83ACFA]/60
            hover:scale-105 hover:shadow-xl hover:border-[#83ACFA]/80">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#387FF5] mr-4
            ...
            <div className="text-left">
              <div className="text-base font-medium text-gray-900 transition-colors duration-300
